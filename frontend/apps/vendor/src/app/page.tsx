...
import { useVendorSelector } from '@/store/store';
    ...
    <div className="space-y-6">
      ...
      {stats?.lowStockProducts > 0 && (
        <div className="flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
          ...
          <a href="/products" className="ml-auto text-xs font-semibold text-amber-700 hover:underline shrink-0">
            View Products →
          </a>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="v-card p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <a href="/orders" className="text-xs text-amber-600 hover:underline font-medium">
              View all →
            </a>
          </div>
