...
import { useVendorSelector, useVendorDispatch, vendorLogout } from '@/store/vendor/store';
...
const NAV = [
  ...
  { href: '/vendor/orders', icon: ShoppingBag, label: 'My Orders' },
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
          <h1 className="font-semibold text-gray-900">
            {NAV.find((n) => pathname === n.href || (n.href !== '/vendor' && pathname.startsWith(n.href)))?.label || 'Dashboard'}
          </h1>
          <div className="flex items-center gap-2.5">
